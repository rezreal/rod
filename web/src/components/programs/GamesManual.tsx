...
export const GAME_DOCS: GameDoc[] = [
  ...
  },
  {
    ...
    rules: [
      'Once armed, the rod moves itself into a starting position — then the servo goes OFF and it moves freely in your hand from there; nothing tugs or drives it again.',
      'No need to hold the button at any point — the round plays on its own. Just keep the rod still, within a tolerance of its starting position.',
    ...
    operate: [
      'Start, tap the device button 3× to arm, then wait for the rod to settle into position — no need to touch anything.',
      'Once it stops, keep it steady there. Feel a buzz? You drifted — settle back down. Stop to end.',
    ],
